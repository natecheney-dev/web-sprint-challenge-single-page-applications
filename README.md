...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    useRouteMatch allows us to get the current url.
1. How would you explain form validation to someone who has never programmed before?
    validation is confirming two things are alike, generally checking to see if several attributes are similar.
1. In 1-2 sentences, define end to end testing.
    End to end testing is testing a product under what live circumstances would be, so from start to finish, checking everything.
